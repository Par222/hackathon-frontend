  ...
  return (
    <div className="flex h-100 w-100">
      <div className="flex flex-col w-1/3">
        ...
        <div className="p-4">
          <div className="p-2 bg-tertiaryblue-200 rounded-md pb-6">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat
            voluptates cumque dicta a, excepturi natus dolore velit earum beatae
            non qui voluptate tempore, inventore optio voluptatem praesentium
            modi. Quasi quae quidem unde consequatur quia doloribus accusamus.
            Doloremque quasi exercitationem minus suscipit voluptatibus quis
            dicta, numtiae ad ab? Blanditiis perferendis accusantium quis
            consectetur!
          </div>
        </div>
      </div>

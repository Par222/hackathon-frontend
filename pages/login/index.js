                    ...
                    {isLogin && <div>
                        ...
                        <form onSubmit={submitHandlerLogin} className="items-center flex flex-col">
                            <div className="flex rounded-md px-3 py-3 w-full justify-center">
                                ...
                                <input id="email" placeholder="Email" className="bg-tertiaryblue-100 bg-opacity-40 border-b-2 border-y-tertiaryblue-200 px-2 rounded-r-md focus:outline-none w-[50%]" value={email} onChange={(e) => {
                            ...
                            <div className="flex rounded-md px-3 py-3 w-full justify-center">
                                ...
                                <input id="password" placeholder="Password" type="password" className="bg-tertiaryblue-100 bg-opacity-40 border-b-2 border-y-tertiaryblue-200 px-2 rounded-r-md focus:outline-none w-[50%]" value={password} onChange={(e) => {
                    ...
                    {!isLogin && <div>
                        ...
                        <form onSubmit={submitHandlerSignup} className="items-center flex flex-col">
                            <div className="flex rounded-md px-3 py-3 w-full justify-center">
                                ...
                                <input id="name" placeholder="Name" className="bg-tertiaryblue-100 bg-opacity-40 border-b-2 border-y-tertiaryblue-200 px-2 rounded-r-md focus:outline-none w-[50%]" value={name} onChange={(e) => {
                            ...
                            <div className="flex rounded-md px-3 py-3 w-full justify-center">
                                ...
                                <select
                                    ...
                                    className=" bg-tertiaryblue-100 bg-opacity-40  border-b-2 w-[50%] border-y-tertiaryblue-200  focus:outline-none py-2 px-1"
                                >

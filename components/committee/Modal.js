...
//   }
  ...
  // },]
  return (
    <div className={`${props.showModal ? "h-[30vh] overflow-hidden" : ""}`}>
        ...
        >
          <div className=" w-full ">
            <div>
              <img src={eventDet.banner} alt="" className="w-full h-[450px] opacity-30" />
            </div>
            <div className="px-5 translate-y-[-100px]">

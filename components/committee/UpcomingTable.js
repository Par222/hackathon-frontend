...
function UpcomingTable(props){
    ...
    return(
        <div>
            <div id="table" className="grid grid-cols-3 gap-10 px-20 ">
                {eventArr.map((event) => (

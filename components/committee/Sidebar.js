...
const Sidebar = (props) => {
    ...
    return(
        <div className="w-full items-center flex font-semibold text-lg flex-row bg-tertiaryblue-200 justify-between ">
            <div className="px-5 py-5 font-bold text-3xl ">
                Committee
            </div>
            <div className="flex flex-row px-5 space-x-2">
                <Link href="/committee">
                    <div className={` ${tabClicked === "overview" ? "border-b-2" : ""} transition-all duration-200 hover:border-b-2 px-5 py-4 cursor-pointer`} id="overview">Overview</div>
                </Link>            
                <Link href="/committee/events">
                    <div className={`  ${tabClicked === "events" ? "border-b-2" : ""} transition-all duration-200 hover:border-b-2 px-5 py-4 cursor-pointer`} id="event details">Events</div>
                </Link>
                <Link href="/committee/members">
                    <div className={`  ${tabClicked === "members" ? "border-b-2" : ""} transition-all duration-200 hover:border-b-2 px-5 py-4 cursor-pointer`} id="members details">Members</div>
                </Link>
                <Link href="/committee/profile">
                    <div className={`  ${tabClicked === "profile" ? "border-b-2" : ""} transition-all duration-200 hover:border-b-2 px-5 py-4 cursor-pointer`} id="profile details">Profile</div>
                </Link>
                {/* <Link href="/ambulance">
